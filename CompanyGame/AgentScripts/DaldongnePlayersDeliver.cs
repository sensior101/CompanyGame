...
public static class DaldongnePlayersDeliver
{
    public static object Export()
    {
        ...
        foreach(string sex in new[]{"Female","Male"})
        {
            ...
            if(!p || !p.GetComponent<CharacterController>() || !p.GetComponent<DaldongneVillageWalker>())throw new Exception("Invalid playable prefab.");
        ...
        AssetDatabase.ExportPackage(new[]{"Assets/Art/Daldongne/Players","Assets/Scripts/World/DaldongnePlayerAppearance.cs","Assets/Scripts/World/DaldongneAvatarMotion.cs","Assets/Scripts/World/DaldongneVillageWalker.cs","Assets/Scripts/World/DaldongneMapCamera.cs"},output,ExportPackageOptions.Recurse);
